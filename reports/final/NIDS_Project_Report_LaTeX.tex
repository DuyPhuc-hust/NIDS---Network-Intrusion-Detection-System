...
\begin{titlepage}
    \begin{center}
        ...
        {\textbf{\Large{Network Intrusion Detection System Using Machine Learning}}}\\[1cm]

        {\textbf{\large{STUDENT NAME}}}\\
        {\large{student@sis.hust.edu.vn}}\\[0.5cm]
        ...
        \resizebox{\textwidth}{!}{%
        \begin{tabular}{ll}
            \multicolumn{1}{l}{\textbf{Supervisor:}} & Dr. Tran Hai Anh \hspace{0.5cm} \\[0.5cm]
            \multicolumn{1}{l}{\textbf{Major:}} & Cyber Security \hspace{0.5cm} \\[0.5cm]
            \multicolumn{1}{l}{\textbf{School:}} & School of Information and Communications Technology \hspace{0.5cm} \\[2.5cm]
...
\begin{tabular}{l c r r r r p{0.16\textwidth}}
\toprule
\textbf{Model} & \textbf{Imb.} & \textbf{Val Macro} & \textbf{Val W-F1} & \textbf{Test Macro} & \textbf{Test W-F1} & \textbf{CV W-F1} \\
\midrule
LR & No & 0.4788 & 0.9224 & 0.4791 & 0.9224 & Skipped \\
LR & Yes & 0.5030 & 0.8940 & 0.4554 & 0.8938 & 0.8821 $\pm$ 0.0018 \\
KNN & No & 0.8818 & 0.9981 & 0.8769 & 0.9982 & 0.9834 $\pm$ 0.0011 \\
KNN & Yes & 0.8252 & 0.9916 & 0.8378 & 0.9914 & Skipped \\
XGB & No & 0.8682 & 0.9987 & 0.8243 & 0.9988 & Skipped \\
XGB & Yes & 0.9459 & 0.9984 & 0.9215 & 0.9985 & 0.9981 $\pm$ 0.0002 \\
RF & No & 0.9536 & 0.9988 & 0.9378 & 0.9987 & Skipped \\
RF & Yes & 0.9497 & 0.9983 & 0.9280 & 0.9985 & 0.9979 $\pm$ 0.0002 \\
\bottomrule
\end{tabular}
\end{table}

In Table 7, LR means Logistic Regression, XGB means XGBoost, and RF means Random Forest.

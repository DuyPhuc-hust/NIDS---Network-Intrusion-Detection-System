...
The \texttt{models/final/} directory is the default inference directory. It contains the model artifacts used by PCAP inference:
...
The \texttt{experiments/models/} folder stores artifacts from different experiment runs. It is separated from \texttt{models/final/} to keep the main model directory clean.
